...
from generated.economy_class_window_ui import UiClassWindowEconomy
...
class ClassWindowEconomy(QDialog, UiClassWindowEconomy):
    def __init__(self, main_window_, id_, time_start, time_end, from_, to_, date_, class_name):
        super().__init__()
        self.window_economy = None
        self.name_ = None
        self.surname_ = None
        self.child_w = None
        self.setupUi(self)
        self.buttons = [self.btn_base_eco, self.btn_standart_eco, self.vtn_plus_eco]
